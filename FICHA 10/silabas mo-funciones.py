...
def promedio_(cant_letras_totales, cant_de_palabras):
    resultado = cant_letras_totales / cant_de_palabras
    return resultado
...
def principal():
    ...
    promedio = promedio_(cant_letras_totales, cant_de_palabras)
